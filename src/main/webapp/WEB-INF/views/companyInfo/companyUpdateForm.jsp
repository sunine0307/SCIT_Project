                ...
                <div class="col-md-12">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                      <strong class="card-title">Update the information</strong>
                    </div>
                    <div class="card-body">
                      <form action="/companyInfo/updateCompany" method="post" onsubmit="return formCheck();">
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="inputName">Name</label>
                            <input type="text" class="form-control" id="inputName" name="company_name" value="${company.company_name}">
                          </div>
                          <div class="form-group col-md-6">
                            <label for="inputLocation">Location</label>
                            <input type="text" class="form-control" id="inputLocation" name="company_location" value="${company.company_location}">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="inputBusiness">Business</label>
                          <input type="text" class="form-control" id="inputBusiness" name="company_business" value="${company.company_business}">
                        </div>
                        <div class="form-group">
                          <label for="inputAlumni">Alumni</label>
                          <input type="text" class="form-control" id="inputAlumni" name="company_alumni" value="${company.company_alumni}">
                        </div>
 						<div class="form-group">
                          <label for="inputLink">Link</label>
                          <input type="text" class="form-control" id="inputLink" name="company_link" value="${company.company_link}">
                        </div>                       
                         <div class="form-row">
                          <div class="form-group col-md-6">
                          ...
                          <input type="hidden" name="company_no" value="${company.company_no}">
                        </div>
                        <br>
        <div id="search-panel">
