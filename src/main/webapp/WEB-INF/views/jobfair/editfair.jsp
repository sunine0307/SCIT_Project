...
<script type="text/javascript">
    ...
    $(document).ready(function(){
         $("#deleteFair").click(function(){
            $.ajax({
               url: "/jobFair/deleteFair",
               data: {
                  jobfair_no : $("#jobfair_no").val()
               },
...
<div class="card shadow mb-4">
                  <div class="card-header">
                    <strong class="card-title">Edit a company </strong>
                  </div>
                  <div class="card-body">
                    <form action="/jobFair/updateJobFair" method="post" onsubmit="return updateCompany();">
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-3 col-form-label">Name</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="name"  name="jobfair_companyName" value="${listOne.jobfair_companyName }">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputOffice" class="col-sm-3 col-form-label">Office</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="office" name="jobfair_office" value="${listOne.jobfair_office }">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputJobDescription" class="col-sm-3 col-form-label">Job description</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="job_description"  name="jobfair_jobDescription" value="${listOne.jobfair_jobDescription }">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputJobDescription" class="col-sm-3 col-form-label">Requirements</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="requirements" name="jobfair_requirements" value="${listOne.jobfair_requirements }">
                        </div>
                      </div>     
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="jobfair_type" id="gridRadios1" value="tokyo" <c:if test="${listOne.jobfair_type eq 'tokyo' }">checked="checked"</c:if>>
                              <label class="form-check-label" for="gridRadios1"> TOKYO FAIR </label>
                            </div>
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="jobfair_type" id="gridRadios2" value="seoul" <c:if test="${listOne.jobfair_type eq 'seoul' }">checked="checked"</c:if>>
                              <label class="form-check-label" for="gridRadios2"> SEOUL FAIR </label>
                            </div>
                            <div class="form-check disabled">
                              <input class="form-check-input" type="radio" name="jobfair_type" id="gridRadios3" value="special" <c:if test="${listOne.jobfair_type eq 'special' }">checked="checked"</c:if>>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea class="form-control" name="jobfair_business" id="exampleFormControlTextarea1" rows="2">${listOne.jobfair_business }</textarea>
                        </div>
                      </div>
                      <div class="form-group mb-2">
                         <input type="hidden" id="jobfair_no" name="jobfair_no" value="${listOne.jobfair_no }">
                         <span>
                            <button class="btn btn-warning" id="deleteFair">Delete</button>
                      </span>
